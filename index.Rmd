...
Kurse <- read_xlsx("KurseMscECMX_WiSe22.xlsx", sheet = "Kursliste") %>%
...
Kurse <- Kurse %>% select(Course, `Offered by`, Location, Language, 'Winter 22') %>%
  rename("Offered in winter 22?" = "Winter 22")
