...
```{r, echo = F}
mhb_baseurl <- 'https://statistik.tu-dortmund.de/storages/statistik/r/Downloads/Studium/Studiengaenge-Infos/ModHb_MSc_ECMTX_2022_November_14.pdf#page='

Kurse <- read_xlsx("KurseMscECMX_SoSe23.xlsx", sheet = "Kursliste") %>%
...
Kurse <- Kurse %>% select(Course, `Offered by`, Location, Language, 'Summer 23') %>%
  rename("Offered in summer 23?" = "Summer 23")
