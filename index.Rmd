...
Kurse <- read_xlsx("KurseMscECMX_WiSe25_26.xlsx", sheet = "Kursliste") %>%
...
Kurse <- Kurse %>% 
  mutate(Course = dplyr::case_when(
    # NO link to MHB
    is.na(MHB) ~ paste("<a href='../../404.html'>", Kurs, "</a>","<br> New course. More info coming soon!", sep = ""),
    MHB == "NA" ~ paste("<a href='../../404.html'>", Kurs, "</a>","<br> New course. More info coming soon!", sep = ""),
    # 
...
Kurse <- Kurse %>% select(Course, Group, Credits, `Offered by`, Location, Language, `Winter 25`) %>%
  rename("Offered in Winter 25?" = "Winter 25")
