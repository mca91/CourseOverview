...
````{r, echo = F}
mhb_baseurl <- 'https://www.statistik.tu-dortmund.de/fileadmin/user_upload/Studium/Studiengaenge-Infos/ModHb_MSc_ECMTX_2022_01_26.pdf#page='

Kurse <- read_xlsx("KurseMscECMX_SoSe22.xlsx", sheet = "Kursliste") %>%
...
Kurse <- Kurse %>% select(Course, `Offered by`, Location, Language, 'Summer 22') %>%
  rename("Offered in summer 22?" = "Summer 22")
