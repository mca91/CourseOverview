...
Kurse$Language[Kurse$Language == "deutsch/englisch"] <- "<img src='germany_flag.png' style='width:21px;height:12px;' alt='DE'><img src='UK_flag.png' style='width:21px;height:12px;' alt='UK'>"
