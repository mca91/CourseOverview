...
Kurse <- read_xlsx("KurseMscECMX_WiSe23.xlsx", sheet = "Kursliste") %>%
...
Kurse <- Kurse %>% select(Course, `Offered by`, Location, Language, 'Winter 23') %>%
  rename("Offered in Winter 23?" = "Winter 23")
